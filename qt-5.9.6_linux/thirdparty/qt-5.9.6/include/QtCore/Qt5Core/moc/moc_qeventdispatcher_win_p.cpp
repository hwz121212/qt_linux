...
#include "../../5.9.6/QtCore/private/qeventdispatcher_win_p.h"
...
struct qt_meta_stringdata_QEventDispatcherWin32_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QEventDispatcherWin32_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QEventDispatcherWin32_t qt_meta_stringdata_QEventDispatcherWin32 = {
    {
QT_MOC_LITERAL(0, 0, 21) // "QEventDispatcherWin32"
...
const QMetaObject QEventDispatcherWin32::staticMetaObject = {
    { &QAbstractEventDispatcher::staticMetaObject, qt_meta_stringdata_QEventDispatcherWin32.data,
      qt_meta_data_QEventDispatcherWin32,  qt_static_metacall, nullptr, nullptr}
};
...
void *QEventDispatcherWin32::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QEventDispatcherWin32.stringdata0))
