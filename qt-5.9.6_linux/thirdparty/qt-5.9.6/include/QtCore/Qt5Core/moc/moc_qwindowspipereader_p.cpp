...
#include "../../5.9.6/QtCore/private/qwindowspipereader_p.h"
...
void QWindowsPipeReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWindowsPipeReader::winError)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWindowsPipeReader::readyRead)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QWindowsPipeReader::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWindowsPipeReader::pipeClosed)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWindowsPipeReader::_q_queueReadyRead)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject QWindowsPipeReader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QWindowsPipeReader.data,
      qt_meta_data_QWindowsPipeReader,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 3
void QWindowsPipeReader::_q_queueReadyRead(QPrivateSignal _t1)
{
