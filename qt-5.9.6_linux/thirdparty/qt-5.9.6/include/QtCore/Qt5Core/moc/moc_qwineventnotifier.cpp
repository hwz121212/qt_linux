...
void QWinEventNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWinEventNotifier::activated)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QWinEventNotifier::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QWinEventNotifier.data,
      qt_meta_data_QWinEventNotifier,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void QWinEventNotifier::activated(HANDLE _t1, QPrivateSignal _t2)
{
