...
#include "../../5.9.6/QtCore/private/qwinoverlappedionotifier_p.h"
...
void QWinOverlappedIoNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWinOverlappedIoNotifier::notified)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWinOverlappedIoNotifier::_q_notify)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QWinOverlappedIoNotifier::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QWinOverlappedIoNotifier.data,
      qt_meta_data_QWinOverlappedIoNotifier,  qt_static_metacall, nullptr, nullptr}
};
